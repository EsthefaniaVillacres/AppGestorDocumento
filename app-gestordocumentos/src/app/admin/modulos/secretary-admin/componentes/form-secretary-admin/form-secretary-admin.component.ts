...
@Component({
  selector: 'app-form-secretary-admin',
  templateUrl: './form-secretary-admin.component.html',
  styleUrls: ['./form-secretary-admin.component.css']
})
export class FormSecretaryAdminComponent {
  @Input() data: any
